...
const DATA = {
  ...
  spots: [
    ...
    },
    {
      ...
      badges: [
        { text: "⚠️ 店舗名を予約票で要確認", cls: "priority-warn" },
        { text: "11:08着＝遅着連絡が必要", cls: "priority-warn" }
      ],
      ratings: { google: "3.5", googleReviews: "63" },
      desc: "貸出9/21 11:00〜返却9/22 19:00。**予約は鳥羽駅前店を想定しているが、予約票での確認がまだ**。この店舗自体は鳥羽駅のすぐそばに実在し、営業は毎日8:00〜19:00。",
      meta: [
        ["営業", "**毎日8:00〜19:00**。返却予約の19:00は**閉店時刻そのもの**なので、余裕を持って返す"],
        ["貸出", "予約は**9/21 11:00開始**。列車の到着が11:08なので、実際の受取は11:15〜11:30になる"],
        ["返却", "予約上は9/22 19:00までだが、**駅前で夕食を取るため16:50〜17:10に返す**"],
        ["車種", "2人・1泊の荷物ならコンパクトか小型ハイブリッド（アクア／ヤリスHV等）が現実的"],
        ["電話", "0599-26-7100"],
        ["持ち物", "予約票・**運転免許証**・決済手段・ETCカード"]
      ],
      notes: "<strong>いま確認すべきことが2つあります。</strong>（1）予約している店舗が本当に「鳥羽駅前店」か。（2）11:00開始の予約に対して<strong>列車の到着が11:08</strong>であること。事前に電話で遅着を伝えるか、開始時刻を11:30へ変更しておいてください。日産ノートe-POWERは希望に合いますが、オリックスの鳥羽店は18時閉店で水族館後の余裕が小さいため、今回はトヨタで確定しています。<strong>返却は同一店舗</strong>（鵜方への乗り捨てはワンウェイ料金が発生し、鳥羽駅前の駐車場代より高くなりやすい）。",
      maps: "トヨタレンタカー 鳥羽駅前店"
    },
    {
      name: "鳥羽駅",
      ...
      meta: [
        ["往路", "**11:08着**（鶴橋9:13発・伊勢志摩ライナー デラックス席）"],
        ["復路", "**19:18発 → 鶴橋21:12頃着**"],
    ...
    },
    {
      ...
      meta: [
        ...
        ["往路", "**9:13発 → 鳥羽11:08着**（伊勢志摩ライナー・デラックス席／約1時間55分）"],
        ["復路", "**鳥羽19:18発 → 21:12頃着**。ここで解散"],
        ["料金", "デラックス席は1人片道**4,400円**（普通運賃2,340円＋特急料金1,640円＋デラックス料金420円）。**2人往復17,600円**で、通常席より+1,680円"],
  ...
  restaurants: [
    ...
    },
    {
      ...
      notes: "<strong>「営業しているか」と「17:30に2名で入れるか」を電話で確認してください。</strong>不定休の情報があるので、予約が取れれば当日の不確実性が一気に減ります。予約が取れると<strong>「遅くとも何時に水族館を出るか」が自動的に決まる</strong>のが大きな利点です。休み・満席なら一栄へ、それも難しければ漣（予約不可・行列リスク）か駅周辺の営業店へ切り替えます。",
      maps: "丸栄 鳥羽"
    },
    {
      name: "一栄",
      ...
      badges: [
        ...
        { text: "この旅行の食べログ最高点に次ぐ", cls: "priority-mid" }
      ],
      ratings: { google: "4.4", googleReviews: "453", tabelog: "3.57", tabelogReviews: "153" },
      desc: "駅近の海鮮・和食。**夜のみの営業**で、予約できれば時間を固定しやすい。点数はGoogle 4.4・食べログ3.57と、今回の候補の中でも上位。",
      meta: [
    ...
    },
    {
      name: "漣 鳥羽店",
      area: "鳥羽市鳥羽3-5-28",
      coords: [34.4835783, 136.8428997],
      category: "backup",
      genre: "海老フライ・洋食系海鮮",
      genreKey: "kaisen",
      areaKey: "toba",
      images: ["images/sazanami.jpg", "images/sazanami_2.jpg", "images/sazanami_3.jpg", "images/sazanami_4.jpg"],
      gmapsPlaceId: "ChIJ6wOaX2haBGAR9gbTdiGr-B0",
      links: [
        { label: "公式サイト", url: "http://sazanami.co.jp/" },
        { label: "食べログ", url: "https://tabelog.com/mie/A2403/A240302/24000445/" }
      ],
      badges: [
        { text: "この旅行の食べログ最高点", cls: "priority-top" },
        { text: "⚠️ 予約不可・行列リスク", cls: "priority-warn" }
      ],
      ratings: { google: "4.3", googleReviews: "2023", tabelog: "3.75", tabelogReviews: "1021" },
      desc: "名物の開き海老フライ。**食べログ3.75・口コミ1,021件はこの旅行の候補で最高**の人気店。ただし**予約ができない**ので、時刻が決まっている今回の旅程では第一候補にしにくい。",
      meta: [
        ["営業", "**11:00〜15:00 / 16:30〜19:30**（土日は10:30〜）"],
        ["定休", "**火曜定休。ただし祝日の場合は営業し、振替休あり**"],
        ["9/22", "火曜だが**祝日なので営業見込み**。念のため電話で確認する"],
        ["電話", "0599-25-2220"],
        ["注意", "**予約不可**。繁忙期は行列と売り切れのリスクがある"],
        ["場所", "鳥羽3丁目。**伊勢店・松阪店とは別**なので、地図で鳥羽店を確認すること"]
      ],
      notes: "<strong>列車の時刻が決まっている日の夕食としては、予約できないことが最大の弱点です。</strong>19:30閉店・L.O.も早いので、17:30に並び始めて入れなければ19:18発に間に合わなくなります。丸栄と一栄がどちらも駄目だったときの三番手として考えてください。逆に、水族館を早く出られた日なら16:30台に入る手もあります。",
      maps: "漣 鳥羽店"
    },
    {
      name: "天びん屋 本店",
  ...
  feature: [
    ...
    { kind: "list", title: "料金と所要の一覧（金具代は別）",
      items: [
        { label: "三重県真珠", text: "**1,980円**（2026年4月以降／繁忙期2,200円）・**20〜45分**・伊勢市二見町・年中無休" },
        { label: "パールファルコ 伊勢店", text: "**2,000円＋金具**・**30〜40分**・伊勢市一色町・室内" },
        { label: "菊池パール", text: "**取り出し1,100円＋金具1,650円〜**・**約40分**・伊勢市通町・水曜定休・加工必須の扱い" },
        { label: "真珠体験 パール美樹", text: "**取り出し3,000円＋金具2,000円〜、または3,500円等（表示に差あり・要電話確認）**・**約60分**・志摩市御座・完全予約制" },
        { label: "真珠工房 真珠の里", text: "**アコヤ貝1個2,500円**（土日祝の事前予約）・**30〜60分**・志摩市越賀・火曜定休" }
      ] },
    ...
    { kind: "sources", title: "主な情報源（最終確認は必ずリンク先で）",
      items: [
        ...
        { label: "グランドメルキュール伊勢志摩 公式", url: "https://grand-mercure-iseshima-resortandspa.jp/" },
        { label: "近鉄 伊勢志摩ライナー 座席案内", url: "https://www.kintetsu.co.jp/gyoumu/Express/train/ise-liner.html" },
        { label: "NEXCO中日本 2026シルバーウィーク交通対策", url: "https://www.c-nexco.co.jp/corporate/pressroom/news_release/6647.html" },
        { label: "鳥羽市観光協会 駐車場案内", url: "https://www.toba.gr.jp/helpful/parking/" }
      ] }
  ]
};
...
const SCHED_DEFAULT = [
  { day: "2026-09-21", time: "08:40", end: "08:50", text: "鶴橋駅で集合。飲み物を買って9:13発に余裕をもって乗る【チケットレスの画面は2人とも出せるように】", status: "confirmed", ref: "spot:鶴橋駅（集合・解散）" },
...
function renderFeature() {
  const box = $("#feature-content"); if (!box) return;
  box.innerHTML = (DATA.feature || []).map(b => {
