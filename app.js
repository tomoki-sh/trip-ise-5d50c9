...
const DATA = {
  ...
  spots: [
    ...
    },
    {
      ...
      notes: "<strong>9月21日13:30・2名で予約が確定しました（予約ID 5511024）。</strong>料金は繁忙期の2,200円×2名＝4,400円で、<strong>現地支払い</strong>です。金具代は体験料とは別なので、加工する場合は当日加算されます。予約内容と控えはチケットタブにあります。<strong>無断キャンセルは100%請求</strong>の規定なので、間に合わなくなりそうなときは着く前に店へ連絡してください。これで「二見で現地ランチ → 体験 → 15時台にホテル」がそのままつながります。<strong>当日の残りの確認事項は、加工まで含めた終了見込みだけ</strong>です（受付時に聞けば足ります）。",
      maps: "三重県真珠 伊勢市二見町"
    },
    {
  ...
  tickets: [
    ...
    },
    {
      ...
      days: ["2026-09-21"],
      summary: "**9/21 13:30・大人2名・4,400円（現地払い）で予約確定**。予約IDは **5511024**。二見のランチのあと、ここへ向かう。",
      meta: [
        ["予約ID", "**5511024**（当日はこの番号で照会できる）"],
        ["予約名義", "白神智貴（シラカミ　トモキ）"],
      ...
      files: [
        { label: "予約確定メール（住所・電話・メールは伏せた控え）", path: "attachments/miekenpearl.eml", type: "eml" }
      ],
      links: [
        { label: "三重県真珠 公式", url: "https://miekenpearl.jp/" }
      ],
      note: "<strong>支払いは現地なので、事前決済は済んでいません。</strong>体験料4,400円に加えて、加工する場合は<strong>金具代が別にかかります</strong>。13:30開始なので、二見のランチは12:55までに切り上げてください。<strong>無断キャンセルは100%請求</strong>の規定です。列車の遅れなどで間に合わなくなりそうなときは、着く前に店へ連絡を入れてください。"
    },
    {
      id: "ticket:レンタカー",
      icon: "🚗",
